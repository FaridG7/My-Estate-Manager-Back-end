let db,queries,jwt;_552‍.x([["setUser",()=>setUser],["getToken",()=>getToken],["authenticateToken",()=>authenticateToken]]);_552‍.w("../postgresDB/db.js",[["default",["db"],function(v){db=v}]]);_552‍.w("./queries.js",[["queries",["queries"],function(v){queries=v}]]);_552‍.w("jsonwebtoken-as-promised",[["default",["jwt"],function(v){jwt=v}]]);
...
async function getUser(manager_id) {
  ...
  try {
    ...
    _552‍.g.console.error("error: ", error);
    return res.status(500).send("Internal Error");
  }
}
