let db,queries,jwt;_f72‍.x([["setUser",()=>setUser],["getToken",()=>getToken],["authenticateToken",()=>authenticateToken]]);_f72‍.w("../postgresDB/db.js",[["default",["db"],function(v){db=v}]]);_f72‍.w("./queries.js",[["queries",["queries"],function(v){queries=v}]]);_f72‍.w("jsonwebtoken-as-promised",[["default",["jwt"],function(v){jwt=v}]]);
...
async function getUser(manager_id) {
  ...
  try {
    ...
    _f72‍.g.console.error("error: ", error);
    return res.status(500).send("Internal Error");
  }
}
